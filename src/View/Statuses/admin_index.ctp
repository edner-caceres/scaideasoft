<div class="statuses index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('name_status'); ?></th>
			<th><?php echo $this->Paginator->sort('description_of_status'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($status['Status']['name_status']); ?>&nbsp;</td>
		<td><?php echo h($status['Status']['description_of_status']); ?>&nbsp;</td>
		<td><?php echo h($status['Status']['is_delete']); ?>&nbsp;</td>
		<td class="actions">
