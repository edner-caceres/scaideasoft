        ...
        <table cellpadding = "0" cellspacing = "0">
            ...
            foreach ($equipment['Item'] as $item):
                ...
                <tr>
                    ...
                    <td><?php echo $this->Html->link($equipment['Equipment']['name_equipment'], array('controller' => 'equipments', 'action' => 'view', $equipment['Equipment']['id'])); ?></td>
                    <td><?php echo $this->Html->link($pieces[$item['piece_id']], array('controller' => 'pieces', 'action' => 'view', $item['piece_id'])); ?></td>
                    <td><?php echo $item['serial_number']; ?></td>
                    <td><?php echo $item['start_date']; ?></td>
                    <td><?php echo $item['end_date']; ?></td>
                    <td><?php echo $item['is_delete']; ?></td>
                    <td><?php echo $this->Html->link($statuses[$item['status_id']], array('controller' => 'statuses', 'action' => 'view', $item['status_id'])); ?></td>
                    <td class="actions">
